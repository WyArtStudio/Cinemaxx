...
public class MoviesNowPlayingFragment extends BaseFragmentMovies implements MovieDataSourcesCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            showLoading(true);
            getMoviesDataSources().getMovies(MoviesDataSources.URL_MOVIE_NOW_PLAYING, this);
        } else {
